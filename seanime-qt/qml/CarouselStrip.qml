...
// One titled horizontal strip of AnimeCards bound to a SearchModel-shaped model.
// Extracted from MediaCarousel so the "split adult content" mode can stack a safe
// strip and a separate adult strip without duplicating the layout, transitions,
// and keyboard navigation. A null/empty model collapses the whole strip.
ColumnLayout {
    id: root

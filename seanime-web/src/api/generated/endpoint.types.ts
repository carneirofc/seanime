 ...
 */
export type SetExtensionGitToken_Variables = {
    repository: string
    token: string
}
 ...
 * @description
 * Route removes the git access token stored for a repository pattern.
 */
export type RemoveExtensionGitToken_Variables = {
    repository: string
}
...
/**
 * - Filepath: internal/handlers/oauth.go
 * - Filename: oauth.go
 * - Endpoint: /api/v1/oauth/clients
 * @description
 * Route registers a new OAuth 2.0 client application.
 */
export type OAuthCreateClient_Variables = {
    name: string
    redirectUris: string
    scopes: string
    trusted: boolean
 ...
 * @description
 * Route issues an authorization code after the user grants consent.
 */
export type OAuthApprove_Variables = {
    clientId: string
    redirectUri: string
    scope: string
    state: string

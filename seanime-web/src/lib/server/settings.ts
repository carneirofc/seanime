...
export const settingsSchema = z.object({
    ...
    hideMediaTagsSpoilers: z.boolean().optional().default(false),
    ...
    blurAdultContent: z.boolean().optional().default(true),
    splitAdultContent: z.boolean().optional().default(true),
    makeAdultEntriesPrivate: z.boolean().optional().default(true),
    ...
    mangaCacheDurationHours: z.number().optional().default(0),
    ...
    mediaCacheDurationHours: z.number().optional().default(0),
...
export const getDefaultSettings = (data: z.infer<typeof gettingStartedSchema>): GettingStarted_Variables => ({
    ...
    anilist: {
        ...
        hideMediaTagsSpoilers: true,
        splitAdultContent: true,
        disableCacheLayer: false,
        mediaCacheDurationHours: 0,
        makeAdultEntriesPrivate: data.makeAdultEntriesPrivate ?? true,
    },

    ...
    children: [
        {
            ...
            children: [
                ...
                { name: "data.json", type: "file", path: "/project/src/data.json" },
            ],
        },
        {
            name: "public",
        ...
        <div>
            ...
            >
                <div className="flex items-center" onClick={toggleOpen}>
                    ...
                    {data.type === "directory" ? (
                        <FiFolder className="w-4 h-4 mr-2 text-(--brand)" />
                    ) : (
                        <FiFile className="w-4 h-4 mr-2 text-(--muted)" />
                    )}
                </div>
                <span
                    className={cn(

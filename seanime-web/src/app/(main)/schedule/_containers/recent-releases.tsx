    ...
    return (
        <AppLayoutStack className="pb-6">
            ...
            <Carousel
                ...
                carouselButtonContainerClass="-top-14"
                autoScroll
            >
                <CarouselDotButtons />
                        ...
                        return (
                            <MediaEntryCard
                                ...
                                overlay={<div className="flex flex-col w-fit absolute right-0 items-end">
                                    <div
                                        className="font-semibold text-white bg-gray-950/80 z-1 pl-3 pr-[0.2rem] w-full py-1.5 text-center tracking-wider! rounded-none rounded-bl-lg"
                                    ...
                                    <div className="text-xs font-semibold z-[-1] w-fit h-fit pl-2 pr-[0.3rem] py-1 ml-2 text-center bg-gray-700/70 rounded-none rounded-bl-lg">
                                        {item.airingAt

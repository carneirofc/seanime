                    ...
                    <div className="">
                        <Form
                            ...
                            onSubmit={async data => {
                                await saveSettings({
                                    ...
                                    manga: {
                                        ...
                                        mangaCacheDurationHours: data.mangaCacheDurationHours ?? 0,
                                    },
                                    mediaPlayer: {
                                    ...
                                    anilist: {
                                        ...
                                        splitAdultContent: data.splitAdultContent,
                            ...
                            defaultValues={{
                                ...
                                hideMediaTagsSpoilers: status?.settings?.anilist?.hideMediaTagsSpoilers ?? false,
                                ...
                                splitAdultContent: status?.settings?.anilist?.splitAdultContent ?? false,
                                makeAdultEntriesPrivate: status?.settings?.anilist?.makeAdultEntriesPrivate ?? true,

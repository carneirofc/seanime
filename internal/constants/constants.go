...
// AnnouncementURL is the announcements feed. It is empty because the fork has no
// feed of its own yet; upstream announcements do not apply to fork builds.
var AnnouncementURL = ""
